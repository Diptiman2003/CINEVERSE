...
export const bannerStyles = {
  ...
  ratingGenreContainer: "flex flex-wrap items-center gap-4 font-[sans serif] mb-6",
  ...
  // Button styles
  buttonsContainer: "flex flex-wrap gap-3 font-[sans serif]",
...
export const navbarStyles = {
  ...
  logoText: "text-lg md:text-sm xl:text-lg lg:tex-lg font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-red-400 to-red-200 font-[sans serif]",
...
export const moviesStyles = {
  ...
  // Movie title
  movieTitle: "text-base sm:text-lg font-[sans serif] ",
  //truncate
  // Category container
  categoryContainer: "mt-1 font-[sans serif]",
...
export const trailersStyles = {
  ...
  leftCard: "bg-white font-[sans serif] rounded-xl shadow-lg p-5 md:p-6",
