        ...
        <div className={signUpStyles.card}>
          ...
          <div className={signUpStyles.cardContent}>
            ...
            <form onSubmit={handleSubmit} className={signUpStyles.form}>
                ...
                <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type="text" id='fullName' name='fullName' required
                      value={formData.fullName} onChange={handleChange} className={`${signUpStyles.input.base}${errors.fullName ? signUpStyles.input.error : signUpStyles.input.normal
                ...
                <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type="text" id='userName' name='userName' required
                      value={formData.userName} onChange={handleChange} className={`${signUpStyles.input.base}${errors.userName ? signUpStyles.input.error : signUpStyles.input.normal
                        } ${signUpStyles.inputWithIcon}`}
                ...
                <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type="email" id='email' name='email' required
                      value={formData.email} onChange={handleChange} className={`${signUpStyles.input.base}${errors.email ? signUpStyles.input.error : signUpStyles.input.normal
                        } ${signUpStyles.inputWithIcon}`}
                ...
                <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type="tel" id='phone' name='phone' required
                      value={formData.phone} onChange={handleChange} className={`${signUpStyles.input.base}${errors.phone ? signUpStyles.input.error : signUpStyles.input.normal
                        } ${signUpStyles.inputWithIcon}`}
                      placeholder='+1 (777) 23-45678'
                    />
                    <div className={signUpStyles.inputIcon}>
                      <Phone size={18} />
                    </div>
              ...
              <div className={signUpStyles.formGrid}>
                <div>
                  <label htmlFor="birthday" className={signUpStyles.field}>
                    DATE OF BIRTH
                  </label>
                  <div className={signUpStyles.inputContainer}>
                    <input type="date" id='birthday' name='birthday' required
                      value={formData.birthday} onChange={handleChange} className={`${signUpStyles.input.base}${errors.birthday ? signUpStyles.input.error : signUpStyles.input.normal
                        } ${signUpStyles.inputWithIcon}`}
                  ...
                  {errors.birthday && (
                    <p className={signUpStyles.errorText}>{errors.birthday}</p>
                  )}
                </div>
                <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type={showPassword ? "text" : "password"} id='password' name='password' required
                      value={formData.password} onChange={handleChange} className={`${signUpStyles.input.base}${errors.password ? signUpStyles.input.error : signUpStyles.input.normal
