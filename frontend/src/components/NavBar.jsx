...
const NavBar = () => {
    ...
    const readAuthFromStorage = () => {
      ...
      if (json) {
        try {
          ...
          setIsAdmin(Boolean(parsed?.isAdmin));  // ← ADD THIS
          return;
        } catch (err) { }
      }
  ...
  //it will open the menu for smaller screreen and also close when escape key is prestent
  const handleLogout = () => {
  ...
  const navItems = [
    ...
    ...(isAdmin ? [{ id: "admin", label: "Admin", icon: User, path: "/admin" }] : []),  // ← ADD THIS
    ...
    < nav className={`${navbarStyles.nav.base} ${isScrolled ? navbarStyles.nav.scrolled : navbarStyles.nav.notScrolled}  `}>
      ...
      <div className={navbarStyles.container}>
        <div className={navbarStyles.logoContainer}>
          ...
          <NavLink to="/" className={navbarStyles.logoText}>
            Cineverse
          </NavLink>
            ...
            {navItems.map((item) => {
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `${navbarStyles.tabletNavLink.base}  ${isActive ? navbarStyles.tabletNavLink.active
            ...
            <div className={navbarStyles.mobileMenuToggle}>
              <button
                ...
                {isMenuOpen ? (
                  ...
                  <Menu className={navbarStyles.mobileAuthIcon} />
                )}
              </button>
            ...
            <div className={navbarStyles.mobileMenuItems}>
              {navItems.map((item) => {
                ...
                return (
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `${navbarStyles.mobileNavLink.base}  ${isActive ? navbarStyles.mobileNavLink.active
              ...
              <div className={navbarStyles.mobileAuthSection}>
                {isLoggedIn ? (
                  ...
                  >
                    <LogOut className={navbarStyles.mobileAuthIcon} /> Logout
                  </button>
                ) : (
