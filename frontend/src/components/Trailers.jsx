//Trailer.jsx                                                                                                                                                                                            import React, { useEffect, useRef, useState } from 'react'
...
const Trailers = () => {
  ...
  };//check the url and verify it for YT
  ...
  //helps playing the video


  if (loading) {
    return (
      <div className={trailersStyles.container}>
        <div className='py-12 text-center text-gray-500'>Loading Trailers...</div>
      </div>
    );
  }
  if (error) {
          ...
          <div className={trailersStyles.leftSide}>
            <div className={trailersStyles.leftCard}>
              ...
              <div className={trailersStyles.carouselControls}>
                ...
                <span className={trailersStyles.trailerCount} >{dataToRender.length}
                  Trailers
                </span>
              </div>
              <div ref={carouselRef} className={trailersStyles.carousel} style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                {dataToRender.map((trailer) => (
                  ...
                  >
                    <img src={trailer.thumbnail || PLACEHOLDER_THUMB}
                      alt={trailer.title}
                ...
                {dataToRender.slice(0, 3).map((trailer) => (
                  ...
                  <div
                    ...
                    <div className={trailersStyles.trendingImage}>
                      <img src={trailer.thumbnail || PLACEHOLDER_THUMB}
                        alt={trailer.title} className={trailersStyles.trendingImageSrc} loading="lazy" />
                    </div>
                ...
                <div className={trailersStyles.infoHeader}>
                  ...
                  <div className={trailersStyles.trailerMeta}>
                    <span className={trailersStyles.metaItem}>
                      <Clock size={16} className={trailersStyles.metaIcon} /> {featuredTrailer?.duration}
                    </span>
                    <span className={trailersStyles.metaItem}>
