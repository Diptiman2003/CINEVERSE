...
import { ToastContainer, toast } from "react-toastify";     // <- new one by chatgpt
import "react-toastify/dist/ReactToastify.css";  //<- this is also
...
const ContactPage = () => {
  const [formData, setFormData] = useState({
    ...
    window.open(`https://wa.me/9348848536?text=${whatsappMessage}`, '_blank');
  };
          ...
          <div className=' inline-flex items-center justify-center '>
            <h1 className={contactStyles.headerTitle}>
               <span className={contactStyles.headerTitleRed}>Contact</span>
                <span className={contactStyles.headerTitleWhite}>
           ...
           <div className={contactStyles.cardGradient} />
            <div className={contactStyles.cardContainer}>
               ...
               <h2 className={contactStyles.formTitle}>
                <MessageCircle className={contactStyles.formTitleIcon} /> Send a message
               </h2>
...
<div className='space-y-6'>
  ...
  <Popcorn className={contactStyles.cardIcon}/>CINEMA INFO
