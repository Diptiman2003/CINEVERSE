...
export const styles5 = {
  ...
  cardImage: "w-full h-44 sm:h-52 md:h-48 lg:h-52 object-cover transition-transform duration-500",
  ...
  detailThumbnailImage: "w-full h-56 object-cover",
  ...
  // Movie Details
  detailPoster: "w-full h-72 object-cover",
